...
static volatile int _temp;
static volatile bool _conversion_done;
...
int temp_sensor_get_reading(void)
{
	...
	ADC12CTL0 |= (ADC12ENC + ADC12ON);		// Enable ADC12
    ...
    t = (int)(((float)_temp - (float)CALADC12_12V_30C) * (85.f - 30.f)) /
            ((float)CALADC12_12V_85C - (float)CALADC12_12V_30C) + 30.0f;

    ADC12CTL0 &= ~(ADC12ENC + ADC12ON);                   // Disable ADC12
...
__interrupt void ADC12ISR (void)
{
  switch(__even_in_range(ADC12IV, ADC12IV_ADC12RDYIFG))
  {
    ...
    case ADC12IV_ADC12IFG0:                 // Vector 12:  ADC12MEM0 Interrupt
    	_temp = ADC12MEM0;                     // Move results, IFG is cleared
